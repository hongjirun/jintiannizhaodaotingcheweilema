<template>
  <view class="page">
    ...
    <view class="search-bar">
      ...
      <text class="search-submit-btn" @tap="doSearch">搜索</text>
      <text class="cancel-btn" @tap="uni.switchTab({ url: '/pages/map/index' })">取消</text>
    </view>
...
.search-submit-btn { font-size: 28rpx; color: #fff; background: #1677ff; padding: 12rpx 24rpx; border-radius: 28rpx; white-space: nowrap; flex-shrink: 0; }
.cancel-btn { font-size: 28rpx; color: #999; white-space: nowrap; flex-shrink: 0; }
